...
if (GlobalVariable.G_LOGINRESULT == 'TRUE') {
    ...
    if (WebUI.verifyElementPresent(obj_Edit, 2, FailureHandling.OPTIONAL)) {
        ...
        if (findTestObject('Object Repository/Page_Account and Profiles/input_ProfileName_Edit')) {
            profile_name = WebUI.getAttribute(findTestObject('Object Repository/Page_Account and Profiles/input_ProfileName_Edit'), 
                'value')

            if (profile_name == profile_Edit) {
              //  WebUI.clearText(findTestObject('Page_Account and Profiles/input_ProfileName_Edit'))

                WebUI.setText(findTestObject('Object Repository/Page_Account and Profiles/input_ProfileName_Edit'), profile_newName)

                WebUI.click(findTestObject('Object Repository/Page_Account and Profiles/button_Save'))

                WebUI.delay(5)

                WebUI.verifyTextPresent(profile_newName, false)
            }
        }
    }
}
